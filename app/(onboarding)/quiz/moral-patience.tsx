...
export default function MoralPatienceScreen() {
    ...
    const handleNext = () => {
        if (selected) {
            updateData({ moralPatience: selected });
            router.push('/(onboarding)/quiz/moral-kindness');
        }
    };
    ...
    return (
        ...
        >
            <View style={styles.contentContainer}>
                <OnboardingTitle>Patience</OnboardingTitle>
                <OnboardingBody>
                    How patient is your child in difficult situations?
                </OnboardingBody>

                <View style={styles.iconContainer}>
                    <Ionicons name="hourglass-outline" size={48} color={OnboardingTheme.Colors.IconColor} />
                </View>
