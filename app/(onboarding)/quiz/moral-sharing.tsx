...
export default function MoralSharingScreen() {
    ...
    const handleNext = () => {
        if (selected) {
            updateData({ moralSharing: selected });
            router.push('/(onboarding)/quiz/moral-honesty');
        }
    };
    ...
    return (
        ...
        >
            <View style={styles.contentContainer}>
                <OnboardingTitle>Sharing</OnboardingTitle>
                <OnboardingBody>
                    How well does your child share toys and belongings with others?
                </OnboardingBody>

                <View style={styles.iconContainer}>
                    <Ionicons name="people-outline" size={48} color={OnboardingTheme.Colors.IconColor} />
                </View>
