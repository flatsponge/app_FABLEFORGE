...
export default function EmailScreen() {
  ...
  const handleNext = async () => {
    ...
    setIsLoading(true);
    try {
      // Store email in context for code verification screen
      setAuthEmail(email);

      // Send OTP to email via Convex Auth
      // For OTP flow, this triggers sending the verification code
      await signIn("resend-otp", { email });

      // Always navigate to code screen - OTP requires verification
