...
import { Book, Category, AvatarItem } from './types';

export const CATEGORIES: Category[] = [
  { id: 'animals', name: 'Animals', color: 'bg-orange-50', text: 'text-orange-600', icon: <Star className="w-5 h-5 text-orange-500" /> },
  { id: 'space', name: 'Space', color: 'bg-indigo-50', text: 'text-indigo-600', icon: <Moon className="w-5 h-5 text-indigo-500" /> },
  { id: 'bedtime', name: 'Bedtime', color: 'bg-blue-50', text: 'text-blue-600', icon: <Cloud className="w-5 h-5 text-blue-500" /> },
  { id: 'fantasy', name: 'Magic', color: 'bg-pink-50', text: 'text-pink-600', icon: <Sparkles className="w-5 h-5 text-pink-500" /> },
];
...
export const BOOKS: Book[] = [
  { 
    ...
    icon: <Moon className="w-12 h-12 text-white opacity-80" />,
    rating: 4.8,
    duration: "5 min",
  ...
  { 
    ...
    icon: <Volume2 className="w-12 h-12 text-white opacity-80" />,
    rating: 4.5,
    duration: "8 min",
  ...
  { 
    ...
    icon: <Star className="w-12 h-12 text-white opacity-80" />,
    rating: 4.9,
    duration: "12 min",
  ...
  { 
    ...
    icon: <Sun className="w-12 h-12 text-white opacity-80" />,
    rating: 4.7,
    duration: "6 min",
  ...
  { 
    ...
    icon: <Sparkles className="w-12 h-12 text-white opacity-80" />,
    rating: 4.9,
    duration: "15 min",
  ...
  { 
    ...
    icon: <Ghost className="w-12 h-12 text-white opacity-80" />,
    rating: 4.6,
    duration: "7 min",
...
export const OUTFITS: AvatarItem[] = [
  { id: 'tshirt-red', color: 'bg-red-400', icon: '👕', type: 'Casual' },
  { id: 'tshirt-blue', color: 'bg-blue-400', icon: '👕', type: 'Cool' },
  { id: 'dress-pink', color: 'bg-pink-300', icon: '👗', type: 'Party' },
  { id: 'jumpsuit-green', color: 'bg-green-400', icon: '🦺', type: 'Adventure' },
  { id: 'hoodie-purple', color: 'bg-purple-500', icon: '🧥', type: 'Cozy' },
];

export const HATS: AvatarItem[] = [
  { id: 'none', icon: <div className="w-6 h-6 border-2 border-slate-300 rounded-full border-dashed" />, label: 'None' },
  { id: 'crown', icon: <Crown className="w-6 h-6 text-yellow-500 fill-yellow-500" />, label: 'Royal' },
  { id: 'cap', icon: <div className="w-6 h-4 bg-blue-500 rounded-t-full" />, label: 'Sporty' },
  { id: 'bow', icon: <div className="w-6 h-3 bg-pink-400 rounded-full" />, label: 'Cute' },
];

export const TOYS: AvatarItem[] = [
  { id: 'none', icon: <div className="w-6 h-6 border-2 border-slate-300 rounded-full border-dashed" /> },
  { id: 'star', icon: <Star className="w-6 h-6 text-yellow-400 fill-yellow-400" /> },
  { id: 'camera', icon: <Camera className="w-6 h-6 text-slate-700" /> },
  { id: 'game', icon: <Gamepad2 className="w-6 h-6 text-indigo-500" /> },
];

// --- STORY ASSETS (Moved from CreateStoryView) ---
